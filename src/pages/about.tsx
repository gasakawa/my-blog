...
const About = () => {
  return (
    <AboutWrapper>
      <h1>Sobre mim</h1>
      <AboutDescription>
        Meu nome é Gabriel Asakawa, sou formado em Engenharia de Computação pela
        Universidad del Valle (Cali - Colombia).
        <br />
        <br />
        Meu primeiro contato com computação foi ainda no Colégio (1999), na aula
        de informática aprendiamos linguagem C. Na época não me interessava
        tanto, porque na verdade eu queria ser Médico, computação era minha
        segunda opção. Mas o destino me levou a estudar computação e já se fazem
        mais de 16 anos brincando com máquinas.
        <br />
        <br />
